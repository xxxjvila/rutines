...
# sex=1:hombres, 2:mujer ( o otro n?mero diferente de zero)
# age=edad en a?os
# coltot=colesterol total en mg/dL
# hdl=colesterol HDL en mg/dL
# tas=TAS en mmHg
# tad=TAD en mmHg
# diab=diabetes (1=s?, 0=no)
# smoke=fumador actual o <1a (1=s?, 0=no)
# calibrated=funci? calibrada (TRUE) o original (FALSE).
# g_chol.men, g_chol.wom:  sum(betes*mean(x))
# S0.men, S0.wom: supervivencia basal (en la media de las covariables)
