...
# proves GitHub
# dades: nom de la base de dades en R
# nom.casecon: nom de la variable que distingeix entre casos i controls
# valor.cas: valor identificador de cas en la variable nom.casecon
# nom.id: nom de la variable identificadora (?nica per individu)
# num.controls: n?mero de controls a matchejar per a cada cas
# var.match: vector character de les variables a matchejar
# tol: toler?ncia per a les variables var.match (amb el mateix ordre)
  # tol=c(0,2)    0, +-2     //  tol=list(c(0,0),c(0,2))     0, [0,2]
# nom.pair: nom de la variable parella
# seed.casos: llavor per als casos
# seed.controls: llavor per als controls
