...
## CVHIST<-only 
  ...
  COEFFMODELS<-read.table(file.path("C:/Users/dgimenez1/Desktop/EURHOBOPCOEFFMODELS.txt"),header=TRUE,sep="\t",as.is=TRUE)
  
  COUNTCHAR<-read.table(file.path("C:/Users/dgimenez1/Desktop/EURHOBOPCOUNTCHAR.txt"),header=TRUE,sep="\t",as.is=TRUE)
