...
#*************                             Referencias de interés:  Marrugat J Rev Esp Cardiol 2003; 56: 253-                                              ************
...
#******** TA sistólica (presis_x), TA diastólica (presdi_x), Antecedente de diabetes (diabetes) y de consumo de tabaco (smoker).



calculadora.risc5a<-function(sex,age,coltot,hdl,tas,tad,diab,smoke,calibrated=TRUE,age.range=c(35,74)){

# sex=1:hombres, 2:mujer ( o otro número diferente de zero)
# age=edad en años
# coltot=colesterol total en mg/dL
# hdl=colesterol HDL en mg/dL
# tas=TAS en mmHg
# tad=TAD en mmHg
# diab=diabetes (1=sí, 0=no)
# smoke=fumador actual o <1a (1=sí, 0=no)
# calibrated=funció calibrada (TRUE) o original (FALSE).


  ########### FUNCIONS PRÈVIES ##########
  dummy<-function(var){   # ha d'estar codificat amb enters consecutius i així amb les etiquetes de valor.
  ...
  attr(bp_cat,"value.labels")<-c("óptima"=1,"bp_normal"=2,"alta"=3,"hipert. grado I"=4,"hipert. grado II"=5)
  bp_dum<-dummy(bp_cat)


  #**********************************************************************************************************************************************
  #********************                                 FUNCIÓN de Framingham  (Circulation 1998)                      **************************
  #**********************************************************************************************************************************************

  #*** Càlculo con la función de Framingham con las características originales de Framingham
  ...
  "Tensión arterial: bp_normal",
  "Tensión arterial: alta",
  "Tensión arterial: hipert. grado I",
  "Tensión arterial: hipert. grado II",
  "Diabético",
  "Fumador")
  ...
  S0.men=ifelse(!calibrated,0.90015+(1-0.90015)/2,1-0.049/2)
  S0.wom=ifelse(!calibrated,0.96246+(1-0.96246)/2,1-0.022/2)

  #* ATENCIÓN: la So que se introduce en la fórmula de la regresión de Cox se estima a partir de la de Hard end-points de Girona y un factor de corrección
