#################################################
####### CALCULA RISC REGICOR / FRAMINGHAM #######
#################################################
...
# snps= matrix on cada fila és el nombre d'alels de risc (0, 1 ó 2) per a cada snp, per a cada individu.
# comp.gen = -0.2462213 # suma del productes de les betes per les prevalences dels alels de risc.
...
# sexo (0 dones, 1 homes)
# edat
# coltot (mg/dl)
# tas (mmHg)
# fuma2 (0 mai ó ex>1a; 1 - actual ó ex<1a)
# diabetes (0 no, 1 sí)
