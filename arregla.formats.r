...
carrega.llibreria(c("chron","Hmisc","gdata"))
...
arregla.formats<-function(taula,identif=NULL,force=FALSE,rate.miss.date=0.5){
  ...
  # force: si és TRUE arregla els formats, encara que l'atribut "formats.arreglats" sigui TRUE.
...
# si la variable data no està definida com a chron, aleshores hauran d'està en el següent format, si no ho deixa a caràcter.
