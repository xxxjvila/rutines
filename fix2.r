...
carrega.llibreria("gdata")

# view=1: noms etiquetes, view=2: valor i etiqueta, view!=1  2: noms valor
# print=TRUE: mostra el data.frame per la consola de R, print=FALSE: mostra el data.frame per una finestra (com la funcio 'fix2')
# rows: selecciona els individus i ha de ser el nombre de la fila de l'individu en el data.frame.
